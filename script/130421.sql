...
-- Volcando datos para la tabla ctldb.departamento: ~3 rows (aproximadamente)
...
INSERT INTO `giroemp` (`idgi`, `descg`, `status`, `edita`, `created_at`, `updated_at`, `deleted_at`, `deleted`) VALUES
	(1, 'industrial', 1, 5, '2021-04-08 20:50:18', NULL, NULL, 0),
	(2, 'servicios', 1, 4, '2021-04-08 20:50:19', NULL, NULL, 0),
	(3, 'comercial', 1, 3, '2021-04-08 20:50:20', NULL, NULL, 0);
...
-- Volcando datos para la tabla ctldb.menu: ~10 rows (aproximadamente)
...
INSERT INTO `menu` (`idm`, `descm`, `status`, `edita`, `created_at`, `updated_at`, `deleted_at`, `deleted`) VALUES
	...
	(15, 'Graffiti', 0, 2, '2021-03-20 20:18:16', '2021-03-20 20:18:16', NULL, 0);
/*!40000 ALTER TABLE `menu` ENABLE KEYS */;

-- Volcando estructura para tabla ctldb.personal
CREATE TABLE IF NOT EXISTS `personal` (
  `idp` int(11) NOT NULL AUTO_INCREMENT,
  `usuario` varchar(15) COLLATE utf8_spanish_ci NOT NULL COMMENT 'Dato unico para cada usuario',
  `contra` varchar(40) COLLATE utf8_spanish_ci NOT NULL COMMENT 'todos',
  `nomp` varchar(25) COLLATE utf8_spanish_ci NOT NULL COMMENT 'todos',
  `app` varchar(25) COLLATE utf8_spanish_ci NOT NULL COMMENT 'todos',
  `email` varchar(30) COLLATE utf8_spanish_ci DEFAULT NULL COMMENT 'todos',
  `idpuesto` int(11) DEFAULT NULL COMMENT 'Control/Editores',
  `idedo` int(11) DEFAULT 7 COMMENT 'publicidad',
  `idgi` int(11) DEFAULT 1 COMMENT 'publicidad',
  `idrc` int(11) DEFAULT NULL COMMENT 'Todos',
  `status` tinyint(4) NOT NULL DEFAULT 1 COMMENT 'todos',
  `edita` int(11) DEFAULT NULL COMMENT 'todos',
  `created_at` datetime DEFAULT NULL,
  `updated_at` datetime DEFAULT NULL,
  `deleted_at` datetime DEFAULT NULL,
  `deleted` int(11) DEFAULT 0,
...
-- Volcando datos para la tabla ctldb.personal: ~10 rows (aproximadamente)
...
INSERT INTO `personal` (`idp`, `usuario`, `contra`, `nomp`, `app`, `email`, `idpuesto`, `idedo`, `idgi`, `idrc`, `status`, `edita`, `created_at`, `updated_at`, `deleted_at`, `deleted`) VALUES
	...
	(3, 'Naomi28', '7110eda4d09e062aa5e4a390b0a572ac0d2c0220', 'Naomi', 'Vicente Gutierrez', 'naomi28@gmail.com', 1, 20, 1, 4, 1, 3, NULL, NULL, NULL, 0),
	...
	(7, 'welk28', '7110eda4d09e062aa5e4a390b0a572ac0d2c0220', 'Victor ivan', 'Vicente jimenez', 'welckarea@gmail.com', 2, 20, 2, 2, 1, 2, NULL, NULL, NULL, 0),
	(16, 'welkito', '7110eda4d09e062aa5e4a390b0a572ac0d2c0220', 'USUARIO', 'UN NUEVO', 'welkito@gmail.com', 2, 2, 1, 13, 1, 2, '2021-04-10 20:43:17', '2021-04-10 20:43:17', NULL, 0),
	(45, 'citlali', '7110eda4d09e062aa5e4a390b0a572ac0d2c0220', 'SALINAS', 'SANTANDER', 'salinasd@gmail.com', 1, 0, 0, 1, 1, 2, '2021-04-13 16:08:50', '2021-04-13 16:08:50', NULL, 0),
	(46, 'santander', '7110eda4d09e062aa5e4a390b0a572ac0d2c0220', 'SANTANDER', 'SALINAS', 'ssantand@gmail.com', 2, 5, 1, 9, 1, 2, '2021-04-13 16:11:03', '2021-04-13 16:11:03', NULL, 0),
	(47, 'claudio', '7110eda4d09e062aa5e4a390b0a572ac0d2c0220', 'CLAUDIO', 'POSADA ESPONOSA', 'claudioposada@gmail.com', 2, 0, 0, 4, 0, 2, '2021-04-13 17:03:59', '2021-04-13 17:03:59', NULL, 0),
	(48, 'pepe', '7110eda4d09e062aa5e4a390b0a572ac0d2c0220', 'FELIPE', 'FELIPE JOSE', 'pepefel@gmail.com', 2, 30, 3, 14, 1, 2, '2021-04-13 17:06:28', '2021-04-13 17:06:28', NULL, 0);
...
-- Volcando estructura para tabla ctldb.pubasigna
CREATE TABLE IF NOT EXISTS `pubasigna` (
  `idp` int(11) NOT NULL,
  `idm` int(11) NOT NULL,
  ...
  KEY `FK2_idm` (`idm`),
  KEY `FK3_edita` (`edita`),
  CONSTRAINT `FK1_idp` FOREIGN KEY (`idp`) REFERENCES `personal` (`idp`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `FK2_idm` FOREIGN KEY (`idm`) REFERENCES `menu` (`idm`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `FK3_edita` FOREIGN KEY (`edita`) REFERENCES `personal` (`idp`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci;

-- Volcando datos para la tabla ctldb.pubasigna: ~13 rows (aproximadamente)
/*!40000 ALTER TABLE `pubasigna` DISABLE KEYS */;
INSERT INTO `pubasigna` (`idp`, `idm`, `status`, `edita`, `created_at`, `updated_at`, `deleted_at`, `deleted`) VALUES
	(2, 7, 1, 5, '2021-04-09 15:09:57', NULL, NULL, 0),
	(3, 6, 1, 4, '2021-04-09 15:07:21', NULL, NULL, 0),
	(4, 5, 1, 5, '2021-04-09 15:06:56', NULL, NULL, 0),
	(5, 1, 1, 2, '2021-04-13 14:58:32', '2021-04-13 14:58:32', NULL, 0),
	(5, 2, 1, 2, '2021-04-13 14:58:32', '2021-04-13 14:58:32', NULL, 0),
	(5, 4, 1, 2, '2021-04-13 14:58:32', '2021-04-13 14:58:32', NULL, 0),
	(5, 5, 1, 2, '2021-04-13 14:58:32', '2021-04-13 14:58:32', NULL, 0),
	(7, 4, 1, 3, '2021-04-09 15:10:19', NULL, NULL, 0),
	(7, 5, 1, 5, '2021-04-09 15:10:32', NULL, NULL, 0),
	(48, 3, 1, 2, '2021-04-13 17:06:28', '2021-04-13 17:06:28', NULL, 0),
	(48, 6, 1, 2, '2021-04-13 17:06:28', '2021-04-13 17:06:28', NULL, 0),
	(48, 8, 1, 2, '2021-04-13 17:06:28', '2021-04-13 17:06:28', NULL, 0),
	(48, 9, 1, 2, '2021-04-13 17:06:29', '2021-04-13 17:06:29', NULL, 0);
/*!40000 ALTER TABLE `pubasigna` ENABLE KEYS */;
...
CREATE TABLE IF NOT EXISTS `rolcargo` (
  ...
  CONSTRAINT `FK2_rolgral` FOREIGN KEY (`idrg`) REFERENCES `rolgral` (`idrg`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=26 DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci COMMENT='contiene los cargos asignados a los usuarios en el rol general';
...
INSERT INTO `rolcargo` (`idrc`, `descc`, `status`, `idrg`, `modifica`, `created_at`, `updated_at`, `deleted_at`, `deleted`) VALUES
	(1, 'Super Administrador', 1, 1, 3, '2021-04-08 19:49:36', NULL, NULL, 0),
	(2, 'Administardor programador', 1, 1, 3, '2021-04-08 19:49:37', NULL, NULL, 0),
	(3, 'Administrador gestion', 1, 1, 2, '2021-04-08 19:49:37', '2021-04-08 21:17:42', NULL, 0),
	(4, 'Contenidos o redactor ', 1, 2, 3, '2021-04-08 19:49:39', NULL, NULL, 0),
	(5, 'Autor activo', 1, 2, 3, '2021-04-08 19:49:39', NULL, NULL, 0),
	(6, 'Autor privilegios', 1, 2, 3, '2021-04-08 19:49:40', NULL, NULL, 0),
	(7, 'Creador', 1, 2, 3, '2021-04-08 19:49:40', NULL, NULL, 0),
	(8, 'Corrector', 1, 2, 3, '2021-04-08 19:49:41', NULL, NULL, 0),
	(9, 'SEO/SEM Manager', 1, 3, 3, '2021-04-08 19:49:42', NULL, NULL, 0),
	(10, 'Contenidos/Copywriter', 1, 3, 3, '2021-04-08 19:49:43', NULL, NULL, 0),
	(11, 'Diseñador/a gráfico/a: ', 1, 3, 3, '2021-04-08 19:49:43', NULL, NULL, 0),
	(12, 'Supervisor', 1, 4, 3, '2021-04-08 19:49:44', NULL, NULL, 0),
	(13, 'Aliados', 1, 4, 3, '2021-04-08 19:49:45', NULL, NULL, 0),
	(14, 'Colaborador', 1, 4, 3, '2021-04-08 19:49:45', NULL, NULL, 0),
	(15, 'Analista', 1, 4, 3, '2021-04-08 19:49:46', NULL, NULL, 0),
	(16, 'Agencias', 1, 4, 3, '2021-04-08 19:49:47', NULL, NULL, 0),
	(17, 'Anunciante', 1, 4, 3, '2021-04-08 19:49:47', NULL, NULL, 0);
...
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci COMMENT='contiene los principales roles asignados a los usuarios';
...
INSERT INTO `rolgral` (`idrg`, `descrg`, `status`, `modifica`, `created_at`, `updated_at`, `deleted_at`, `deleted`) VALUES
	(1, 'Grupo control', 1, 5, '2021-04-08 19:40:48', NULL, NULL, 0),
	(2, 'Grupo editores', 1, 3, '2021-04-08 19:40:48', NULL, NULL, 0),
	(3, 'Contenido', 1, 5, '2021-04-08 19:40:49', NULL, NULL, 0),
	(4, 'Grupo publicidad', 1, 3, '2021-04-08 19:40:50', NULL, NULL, 0);
